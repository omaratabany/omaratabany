...
CS graduate (University of Wollongong in Dubai) and production certificate holder (SAE Institute) running infrastructure at both ends of the stack — self-hosted ~62TB media systems, enterprise pre-sales across VMware · Fortinet · Kaspersky, and a fabrication company deploying and servicing industrial 3D printers across UAE institutions.
...
![Kaspersky](https://img.shields.io/badge/Kaspersky-006D5C?style=flat-square&logo=kaspersky&logoColor=white)&nbsp;
...
| **Storage** | ~62TB TerraMaster DAS · NVMe cache · LSI LP HBA JBOD SSD array |
| **Personal PC** | i9-13900KF · 64GB DDR5 · RTX 4090 · 14TB |
| **Network** | UniFi stack · Cloudflare Tunnel · VLAN segmentation · DU Telecom |
| **Printers** | Creality Hi (FDM) · Bambu P2S (FDM) · Industrial pellet-fed FDM · PETG primary |
...
| | |
|---|---|
| **B.Sc. Computer Science** | University of Wollongong in Dubai |
| **Film Production Certificate** | SAE Institute Dubai |
